...
public class NodeMeshConstructor : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Event_Manager.Instance.AddListener(E_Event.Terrain, E_Action.Finished, StartMeshGeneration);
    }

    // Update is called once per frame
    void StartMeshGeneration()
    {
        Event_Manager.Instance.InvokeEvent(E_Event.RoadPolygons, E_Action.Start);
    ...
    IEnumerator CreatePolygonFromNodes() 
    {
        ...
        Event_Manager.Instance.InvokeEvent(E_Event.RoadPolygons, E_Action.Finished);
    }
